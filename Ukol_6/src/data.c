 ...
 * Jak vidíte níže, void nemá definován žádný konstruktor - funkci typu Init, Create nebo Construct.
 * void je totiž čistě abstraktní typ - nikdy nebudete tvořit jeho instance.
 */
