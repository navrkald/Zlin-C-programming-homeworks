...
#include "data.h"
/*!
 * \brief typ Data_Person_t je datový typ s konstantní velikostí a Data_t rozhraním
 */
typedef struct {
...
void Data_Person_Init(Data_Person_t * d, char * str, double age, double weight, double height);
